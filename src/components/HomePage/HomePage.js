                ...
                <div className="row">
                  <div className="col-lg-7">
                    ...
                    <p>
                      ...
                      body at a college which directly reports to Google for
                      their activities and is supported by the tech giant.
                  ...
                  <div className="col-lg-7">
                    ...
                    <p className="row">
                      <span className="col-lg-6">
                        <i className="fa fa-angellist" /> Android App
                        Development <br />
                      </span>

                      <span className="col-lg-6">
                        <i className="fa fa-angellist" /> Actions on Google{" "}
                        <br />
                      </span>

                      <span className="col-lg-6">
                        <i className="fa fa-angellist" /> Machine Learning{" "}
                        <br />
                      </span>

                      <span className="col-lg-6">
                        <i className="fa fa-angellist" /> Chrome Extension{" "}
                        <br />
                      </span>
                  ...
                  <div className="col-lg-7 tab">
                    ...
                    <p>
                      <b>
                        <ul>
                          <li>
                            Grow your knowledge on developer technologies and
                            more through peer to peer workshops and events.
                          </li>
                          <br />
                          <li>
